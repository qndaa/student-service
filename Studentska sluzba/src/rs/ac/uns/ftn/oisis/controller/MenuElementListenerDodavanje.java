...
public class MenuElementListenerDodavanje implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (TabbedPane.activeTab == 0) {
			DodavanjeStudentaDijalog di = new DodavanjeStudentaDijalog(MainFrame.getInstance(), "Dodavanje studenta",
					true);
			di.setVisible(true);
		}
		...
		if (TabbedPane.activeTab == 2) {
			DodavanjeProfesoraDialog di = new DodavanjeProfesoraDialog(MainFrame.getInstance(), "Dodavanje profesora",
					true);
			di.setVisible(true);
		}
