...
public class PredmetDialog extends JDialog{
	...
	protected JTextField txtSifrePredmeta;
	protected JTextField txtNazivPredmeta;
	protected JComboBox<String> semestarCB;
	protected JComboBox<String> godinaCB;
	
	protected JButton odustaniBtn;
	protected JButton potvrdaBtn;
